...
{
    class DataLoaderDLICNbFIA10YrC : DataLoader
    {

        string inputFolder;
        static object toLock = new object();
        int headerRow = 1;
        public DataLoaderDLICNbFIA10YrC()
        {
            inputFolder = "W:\\DACT\\ALM\\FIAHedging\\DBUpload\\DLIC NB FIA RC10\\ToUpload\\";
            OutputPath = "W:\\DACT\\ALM\\FIAHedging\\DBUpload\\DLIC NB FIA RC10\\";
        }
